...
$que = $_SESSION['total_questions'];

// set total questions into session
$_SESSION['que'] = $que;
...
if(!isset($_SESSION['i'])) {
	$_SESSION['i'] = 0;
} else if($_SESSION['i'] == $que) {
	header("location: exam1.php");
}

// die after 600 seconds = 10 minutes
//header( "refresh:600;url=result.php" );
					...
					if(uname != '') {
						...
						$.ajax({
							...
							success : function(response) {
								var response_brought_exam = response.indexOf('exam.php');
